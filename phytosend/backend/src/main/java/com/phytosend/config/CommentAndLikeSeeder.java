...
/**
 * Classe responsabile del seeding automatico di commenti e like nel database.
 * Viene eseguita all'avvio dell'applicazione e popola il database con commenti
 * e like in base ai post presenti.
 * Eredita da CommandLineRunner e viene eseguita dopo il CatalogSeeder.
 */
@Component
...
public class CommentAndLikeSeeder implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                if (allPosts.isEmpty()) {
                        log.warn("Nessun post trovato, impossibile generare commenti e like.");
                        return;
                }
                ...
                if (aloeVaso != null) {
                        ...
                        addReply(aloeVaso, c1, admin,
                                        "Terriccio specifico per cactacee con molta perlite, mi trovo benissimo!", 4);
                }
                ...
                if (falangioStoloni != null) {
                        ...
                        Comment c2 = addComment(falangioStoloni, miriam,
                                        "Io volentieri! Sarei curiosa di provare a coltivarla.",
                                        12);
                ...
                if (falangioSecco != null) {
                        ...
                        Comment c3 = addComment(falangioSecco, federica,
                                        "Di solito è l'aria troppo secca. Prova a nebulizzare le foglie la mattina!",
                                        3);
                ...
                if (basilicoPesto != null) {
                        ...
                        addComment(basilicoPesto, alessandro,
                                        "Gnam! Il pesto fatto in casa con il proprio basilico è tutta un'altra cosa. 🍝",
                                        7);
                        Comment c24 = addComment(basilicoPesto, marco,
                                        "Il trucco per il pesto perfetto è usare i pinoli tostati e tanto tanto Parmigiano.",
                                        6);
                        addReply(basilicoPesto, c24, alessandro,
                                        "Eresia! A Genova si usa anche il Fiore Sardo, non solo Parmigiano! 😂", 5);
                        addReply(basilicoPesto, c24, admin,
                                        "Ragazzi non litigate, l'importante è che il basilico sia fresco!", 4);
                }
                ...
                if (basilicoBuchi != null) {
                        ...
                        Comment c4 = addComment(basilicoBuchi, elena,
                                        "Potrebbero essere nottue (bruchi verdi). Esci la sera col buio e controlla sotto le foglie!",
                                        2);
                        addReply(basilicoBuchi, c4, admin, "Mi sa che hai ragione, ne ho appena pizzicato uno. Grazie!",
                                        1);
                }
                ...
                if (rosmarinoProfumo != null) {
                        ...
                        addComment(rosmarinoProfumo, alessandro,
                                        "Verissimo! Basta sfiorarlo per avere le mani profumate per ore.",
                                        15);
                }
                ...
                if (rosmarinoAdmin != null && matteo != null) {
                        ...
                        addReply(rosmarinoAdmin, cMatteo4, admin,
                                        "Wow, un bonsai di rosmarino deve essere stupendo! Seguirò il tuo consiglio per il concime.",
                                        5);
                }
                ...
                if (orchideaRifiorisce != null) {
                        ...
                        Comment c6 = addComment(orchideaRifiorisce, elena,
                                        ...
                                        5);
                        addReply(orchideaRifiorisce, c6, miriam,
                                        "Esatto! Da quando ho smesso di ossessionarmi è rinata 😂", 4);
                ...
                if (pothosLibreria != null) {
                        ...
                        addComment(pothosLibreria, admin,
                                        "Fagli fare una bella cascata verso il basso, sarà stupendo da vedere.",
                                        25);
                }
                ...
                if (pothosSbiadito != null) {
                        ...
                        Comment c8 = addComment(pothosSbiadito, marco,
                                        ...
                                        10);
                        addReply(pothosSbiadito, c8, miriam,
                                        "Ha tantissimo senso! Grazie mille Marco, lo sposto subito.", 9);
                }
                ...
                if (lavandaProfumo != null) {
                        ...
                        addReply(lavandaProfumo, c9, miriam,
                                        "Qui a Trapani il clima le piace tantissimo, prende sole dalla mattina alla sera!",
                                        5);
                }
                ...
                if (cactusForte != null) {
                        ...
                        addComment(cactusForte, admin,
                                        "È la magia delle succulente! Meno le guardi e meglio stanno. 🌵", 14);
                }
                ...
                if (cactusMalato != null) {
                        ...
                        addReply(cactusMalato, c10, marco, "Ci provo subito, incrociamo le dita! Speriamo di salvarlo.",
                                        7);
                }
                ...
                if (salviaCucina != null) {
                        ...
                        addComment(salviaCucina, elena,
                                        "Che invidia! Devo assolutamente piantare anche io le aromatiche sul balcone.",
                                        5);
                }
                ...
                if (ficusLucido != null) {
                        ...
                        addComment(ficusLucido, miriam,
                                        "Che splendore! Usi qualche prodotto specifico o solo acqua per pulirle?",
                                        20);
                }
                ...
                if (ficusFederica != null && matteo != null) {
                        ...
                        addReply(ficusFederica, cMatteo3, federica,
                                        "Sì Matteo! L'ho allontanato dalla finestra per via del termosifone acceso. Sarà stato quello!",
                                        7);
                ...
                if (ranuncoloBoccioli != null) {
                        ...
                        addComment(ranuncoloBoccioli, elena,
                                        "I ranuncoli sono la perfezione. Sembrano finti da quanto sono belli!",
                                        6);
                }
                ...
                if (geranioFarfallina != null) {
                        ...
                        addReply(geranioFarfallina, c14, federica, "Lo compro oggi stesso, grazie mille Alessandro!",
                                        4);
                }
                ...
                if (giglioBianco != null) {
                        ...
                        addComment(giglioBianco, elena,
                                        "Bianco è super elegante. Ne ho preso uno anche io la settimana scorsa!",
                                        18);
                }
                ...
                if (giglioPolline != null) {
                        ...
                        Comment c15 = addComment(giglioPolline, federica,
                                        ...
                                        12);
                        addReply(giglioPolline, c15, alessandro,
                                        "D'ora in poi lo farò sempre, ho rovinato una maglietta ieri!",
                                        11);
                }
                ...
                if (ortensiaBlu != null) {
                        ...
                        addComment(ortensiaBlu, federica,
                                        "Che spettacolo! Io non riesco mai a farle diventare azzurre, restano sempre rosa scuro.",
                                        15);
                ...
                if (ortensiaClorosi != null) {
                        ...
                        addReply(ortensiaClorosi, c17, alessandro, "Perfetto, procedo con il chelato. Grazie Doc! 😎",
                                        5);
                }
                ...
                if (calatheaMovimento != null) {
                        ...
                        addComment(calatheaMovimento, federica,
                                        "Le Calathee sono pazzesche, sembrano chiudersi a preghiera la sera. Bellissima!",
                                        19);
                ...
                if (calatheaPunte != null) {
                        ...
                        Comment c18 = addComment(calatheaPunte, admin,
                                        ...
                                        11);
                        addReply(calatheaPunte, c18, elena,
                                        "Ci provo subito! Ero disperata, le punte diventavano marroni ovunque.",
                                        10);
                }
                ...
                if (rosaVaso != null) {
                        ...
                        addComment(rosaVaso, alessandro,
                                        "Le rose antiche hanno un profumo che non si dimentica. Stupenda!", 13);
                }
                ...
                if (timoApi != null) {
                        ...
                        addComment(timoApi, miriam,
                                        "Bellissimo vedere la natura al lavoro. E il miele di timo dev'essere buonissimo! 🐝",
                                        9);
                }
                ...
                if (bambuRadici != null) {
                        ...
                        addReply(bambuRadici, cMatteo1, matteo,
                                        "Grazie mille Salvatore! Provvederò a mettere la barriera al prossimo rinvaso.",
                                        4);
                }
                ...
                if (aceroRosso != null) {
                        ...
                        addComment(aceroRosso, elena,
                                        "Che meraviglia assoluta! L'acero è nella mia wishlist da tantissimo tempo.",
                                        10);
                }
                ...
                if (limoneFiori != null) {
                        ...
                        Comment cMatteo2 = addComment(limoneFiori, alessandro,
                                        "Il profumo dei fiori di limone è pazzesco. Ricordati di concimare con i lupini macinati!",
                                        3);
                        addCommentLike(cMatteo2, matteo);
                }

                log.info("Autoseed commenti e like completato!");
        }
