...
import { X, Loader, Plus, Skull, Trash2, Sprout, Info, CalendarHeart, Droplets, Image as ImageIcon, Heart, MessageCircle, ArrowLeft, AlertTriangle, CheckCircle } from 'lucide-react';
